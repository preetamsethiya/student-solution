...
export default function Privacy() {
  return (
    <div>
      <main>
        <Page_Container>
          <h2>Privacy Policy for Student solution </h2>
          <p>
            At Student solution , accessible at undefined, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Student solution and how we use it.
          </p>
          <p>
            If you have additional questions or require more information about
            our Privacy Policy, do not hesitate to contact us through email at
            studentsolution25@gmail.com
          </p>
          <p>
            This privacy policy applies only to our online activities and is
            valid for visitors to our website with regards to the information
            that they shared and/or collect in Student solution . This policy is
          ...
          <p>
            ...
            information, including items such as name, Student solution ,
          ...
          <p>
            Student solution follows a standard procedure of using log files.
          ...
          <p>
            Like any other website, Student solution uses ‘cookies'. These
          ...
          <p>
            ...
            advertising partners of Student solution .
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Student solution
          ...
          <p>
            Note that Student solution has no access to or control over these
          ...
          <p>
            Student solution 's Privacy Policy does not apply to other
          ...
          <p>
            Student solution does not knowingly collect any Personal
